...
public class TimestampWorkdirResourceFactoryTest {
    ...
    public void testCreateInstancePrefix() throws Exception {
        ...
        DateTime fileStamp = DateTimeFormat.forPattern("yyyyMMddHHmmss").parseDateTime(nameParts[0] + nameParts[1]);
        log.debug(fileStamp);
        assertTrue(fileStamp.isBefore(currentStamp));
        assertTrue(fileStamp.isAfter(currentStamp.minusSeconds(1)));
