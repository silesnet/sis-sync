package cz.silesnet.infrastructure.stormware.schema;
...
/**
 * User: der3k Date: Mar 13, 2010 Time: 10:59:40 PM
 */
public class InvoiceTest {
  ...
  public void testMarshalMapping() throws Exception {
    ...
    JAXBElement<DataPackType> dataPackElement = new JAXBElement<DataPackType>(
        new QName("dataPack"), DataPackType.class, dataPack);
  ...
  public void testUnmarshalMapping() throws Exception {
    String invoicesResponseXml = ""
        ...
        + "          <rdc:note>Datum nen� z ��etn�ho obdob�.</rdc:note>\n"
        ...
        + "          <rdc:state>warning</rdc:state>\n"
        + "          <rdc:errno>606</rdc:errno>\n"
        + "          <rdc:note>Datum m�e b�t nejv�e 31.12.2009.\n"
        + "\n"
        + "Tip: Pokud chcete zadat doklad z po��tku dal��ho obdob�,\n"
        + "nastavte ��etnictv�/Uz�v�rka/��tov�n� na p�elomu ��etn�ho obdob�.</rdc:note>\n"
        + "          <rdc:XPath>dat:dataPack/dat:dataPackItem[1]/inv:invoice/inv:invoiceHeader/inv:date</rdc:XPath>\n"
        + "          <rdc:valueRequested>08.03.2010</rdc:valueRequested>\n"
        + "          <rdc:valueProduced>08.03.2010</rdc:valueProduced>\n"
        + "        </rdc:detail>\n"
    ...
    while (streamReader.getEventType() == XMLStreamConstants.START_ELEMENT) {
      ...
      JAXBElement<ResponsePackItemType> invoiceResponse = unmarshaller.unmarshal(streamReader,
          ResponsePackItemType.class);
      StringBuilder number = new StringBuilder(invoiceResponse.getValue().getInvoiceResponse()
          .getProducedDetails().getNumber());
      number.append(" ").append(
          invoiceResponse.getValue().getInvoiceResponse().getImportDetails().getDetail().get(0)
              .getState());
